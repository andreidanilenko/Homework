class Vehicle:
    __COLOR_VARIANTS = ['blue', 'red', 'green', 'black', 'white', 'yellow', 'gray']   # Допустимые цвета для окрашивания
...
class Sedan(Vehicle):
    __PASSENGERS_LIMIT = 5      # (в седан может поместиться только 4 пассажира и 1 водитель)

vehicle1 = Sedan('Andrei', 'KIA Picanta', 67, 'white')

# Изначальные свойства
vehicle1.print_info()

# Меняем свойства (в т.ч. вызывая методы)
vehicle1.set_color('Navy blue')
vehicle1.set_color('Blue')
vehicle1.owner = 'Alexey'
